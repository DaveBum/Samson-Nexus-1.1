...
Original file is located at
    https://colab.research.google.com/drive/1j1BC_1xEe1GRi31vGJpzzFKQrDVPtAXV
"""
...
extract_dir = r'C:\Users\Davi\Downloads\EMO-main'  # Use raw string literal to avoid Unicode escape errors
...
def manage_conversation():
    ...
    while not stop_signal:
        ...
        memory.append(f"Samson: {response}")
...
# GUI Setup
root = Tk()
root.title("EMO Conversation Manager")
...
status_label_text.set("Status: Idle")
status_label = Label(root, textvariable=status_label_text)
